...
import com.tcy.mytally.adapter.RecordPageAdapter;
...
//        创建适配器
        RecordPageAdapter pagerAdapter = new RecordPageAdapter(getSupportFragmentManager(), fragmentList);
//        设置适配器
